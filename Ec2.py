...
class Ec2:
    ...
    def start_instances(self, instance_ids):
        print("To start these instances, open Ec2.py and activate start_instance command: " + str(instance_ids))
        #self.ec2.start_instances(InstanceIds = instance_ids)

    def stop_instances(self, instance_ids):
        print("To stop these instances, open Ec2.py and activate stop_instance command: " + str(instance_ids))
